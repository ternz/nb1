...
#define MTP_EV_READ_ONE			EPOLLIN | EPOLLONESHOT
#define MTP_EV_WRITE_ONE		EPOLLOUT | EPOLLONESHOT
#define MTP_EV_READ_WRITE_ONE	EPOLLIN | EPOLLOUT | EPOLLONESHOT
